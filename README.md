...
```text
to-java.xsl              79116  37.34%
classes.xsl              65779  31.04%
set-locators.xsl         17475  8.25%
set-original-names.xsl   11810  5.57%
attrs.xsl                9696   4.58%
data.xsl                 9037   4.26%
tests.xsl                6419   3.03%
package.xsl              6385   3.01%
anonymous-to-nested.xsl  6191   2.92%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-12 at 12:03,
on Linux with 4 CPUs.
The total is 211908 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/19296514255
